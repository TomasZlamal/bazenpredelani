...
<section class="max-w-[45rem] mx-20 flex flex-col">
    ...
    <small>Small</small>
    <x-callout :type="\App\Enums\CalloutEnum::INFO">
        <p>Gleb</p>
    </x-callout>
    <x-callout :type="\App\Enums\CalloutEnum::DANGER">
        <p>Vnitřní bazén, <b>včetně atrakcí</b>, je z důvodu rekonstrukce uzavřen.</p>
    </x-callout>
    
    <x-callout :type="\App\Enums\CalloutEnum::WARNING">
        <p>Za každou překročenou minutu je účtován doplatek 2,- Kč / minuta (při pobytu v bazénu) nebo 4,- Kč / minuta
            (při pobytu v sauně), a to bez ohledu na to, zda se jedná o zakoupené plné či slevové vstupné.</p>
        <p>Za ztrátu jakéhokoliv čipového náramku či karty je účtován poplatek 200,- Kč. Za nalezení a vrácení čipu po
            době pobytu v areálu se uhrazená částka nevrací.</p>
        <p>V případě opětovného nálezu čipového náramku či karty v době pobytu nebo nouzového otevření skříňky je
            účtován pouze manipulační poplatek 100,- Kč.</p>
    </x-callout>
...
<x-blue-section>
    <div class="max-width-blog-container">
        ...
        <ul>
            ...
            <li>studující řádného studia od 15 do 26 let věku - nutno prokázat žákovským nebo studentským průkazem
                současně s obč. průkazem (JIS karta, ISIC).
            </li>
