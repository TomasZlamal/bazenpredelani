<x-layouts.app title="Ceník">
    ...
    <section class="flex flex-col justify-center p-0 mt-12">
        ...
        <div class="flex flex-col items-center bg-bs-yellow py-10">
            ...
            <p class="w-[60vw]">Za každých překročených 15 minut je účtován doplatek 20,- Kč (při pobytu v bazénu) nebo 40,- Kč (při pobytu v sauně), a to bez ohledu na to, zda se jedná o zakoupené plné či slevové vstupné. Překročení není možné uhradit další zakoupenou hodinou.
