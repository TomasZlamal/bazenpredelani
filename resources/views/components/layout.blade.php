...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <header>
            <nav aria-label="hlavní-menu" id="nav" class="fixed w-full z-20 py-4 lg:px-12 md:px-8 px-4 transition-all duration-300 translate-y-0 bg-bs-white">
                <div class="mx-auto max-w-content">
                    <div class="flex h-16 items-center justify-between">
                        <div class="flex items-center">
                            <div class="flex shrink-0 items-center">
                                <img class="h-16 w-auto" src="logo-bazen.png" alt="Your Company" />
                            </div>
                        </div>
